...
public class HotNewsAdapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements UpdateUIFollowBookmarkChild {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ARTICLE:
                View viewArticle = mLayoutInflater.inflate(R.layout.item_article_hot_news_in_latest_news, viewGroup, false);
                return new HotNewsAdapter3.ArticleViewHolder(viewArticle);
            case VIEW_TYPE_EVENT:
                View viewEvent = mLayoutInflater.inflate(R.layout.item_event_hot_news, viewGroup, false);
                return new HotNewsAdapter3.EventViewHolder(viewEvent);
            case VIEW_TYPE_STORY:
                View viewStory = mLayoutInflater.inflate(R.layout.item_stories_hot_news, viewGroup, false);
                return new HotNewsAdapter3.StoryViewHolder(viewStory);
            case VIEW_TYPE_LOADING:
                View viewLoading = mLayoutInflater.inflate(R.layout.item_loading, viewGroup, false);
                return new HotNewsAdapter3.LoadingViewHolder(viewLoading);
            case VIEW_TYPE_FOOTER:
                View viewFooter = mLayoutInflater.inflate(R.layout.item_footer_recycler_view, viewGroup, false);
                return new HotNewsAdapter3.FooterViewHolder(viewFooter);
        }
...
//                return;
//            }
            HotNewsAdapter3.ArticleViewHolder articleViewHolder = (HotNewsAdapter3.ArticleViewHolder) viewHolder;
